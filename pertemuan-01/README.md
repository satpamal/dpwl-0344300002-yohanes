# P1 - Pengantar DPWL dan Konsep MVC Judul artefak.

## 1. Identitas Mahasiswa 
Nama, NIM, kelas, dan repositori.

## 2. Kesinambungan PWD-DPW-DPWL 
Ringkas kompetensi PWD dan DPW yang menjadi landasan DPWL.

## 3. PHP Terstruktur vs MVC 
Jelaskan perbedaan pengorganisasian dan pemisahan tanggung jawab.
...
## 7. Kesimpulan P1 
Simpulkan pemahaman yang diperoleh dan kaitannya dengan P2